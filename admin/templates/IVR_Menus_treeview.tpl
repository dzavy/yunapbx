...
{if $Key > -1}
	<img src="../static/images/tree_icons/folder.gif" alt="folder" /> ( {$Key} )
{else}
	<img src="../static/images/tree_icons/base.gif"  alt="base"/>
{/if}
{$IVR_Tree.Name}
</a>
...
<ul {if $Key==""}id="treeview"{/if}>
	...
	<li>
		...
		<img src='../static/images/tree_icons/final.gif' alt="final"/>
		Listen for Options
		</a>
	</li>
	...
	{foreach from=$IVR_Tree.Visited key=Key item=IVR_Option}
		<li>
			<img src="../static/images/tree_icons/page.gif" alt="page" />
