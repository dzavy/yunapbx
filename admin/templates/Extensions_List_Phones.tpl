	...
	<tr>
		<td>
			...
			<select id="View" name="View">
				...
				<option value="Extensions_List_Phones.php" selected="selected">Only Phones</option>
...
<table class="listing fullwidth">
	<caption>Phone Extensions ( {$Start+1} to {$End} ) of {$Total}</caption>
	<thead>
	<tr>
		<th>
...
<p class="warning_message">
	There are no phone extensions defined on this system. 
