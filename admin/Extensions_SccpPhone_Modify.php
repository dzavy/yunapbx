...
function Extensions_SccpPhone_Modify() {
    global $mysqli;
    
    $session = &$_SESSION['Extensions_Sccp_Modify'];
    ...
    return $smarty->fetch('Extensions_SccpPhone_Modify.tpl');
}
...
admin_run('Extensions_SccpPhone_Modify', 'Admin.tpl');
?>
