		...
		case 'UpdateCIDRule':
			...
			$query = "
				...
				SET
					...
					ExtensionStart  = '".mysql_real_escape_string($data['ExtensionStart'])."',
					ExtensionEnd    = '".mysql_real_escape_string($data['ExtensionEnd'])."',
					FK_OutgoingRule = '".mysql_real_escape_string($data['FK_OutgoingRule'])."',
					`Add`           =  ".intval($data['Add']).",
