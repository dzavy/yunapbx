...
function Extensions_Action_Modify() {
    ...
    $session = &$_SESSION['IVR_Action_Modify_say_number'];
    ...
    return $smarty->fetch('IVR_Actions_Modify.say_number.tpl');
}
...
function formdata_save($data) {
    ...
    if ($data['PK_Action'] == "") {
        ...
        $query = "INSERT INTO IVR_Actions (FK_Menu, `Order`, Type) VALUES({$data['FK_Menu']}, {$data['Order']}, 'say_number')";
