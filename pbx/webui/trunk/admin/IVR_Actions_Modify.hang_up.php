...
function Extensions_Action_Modify() {
	...
	$session = &$_SESSION['IVR_Action_Modify_hang_up'];
	...
	return $smarty->fetch('IVR_Actions_Modify.hang_up.tpl');
}
...
function formdata_save($data) {
	if ($data['PK_Action'] == "") {
		...
		$query = "INSERT INTO IVR_Actions (FK_Menu, `Order`, Type) VALUES({$data['FK_Menu']}, {$data['Order']}, 'hang_up')";
