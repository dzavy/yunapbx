...
<p style="font-weight: bold;">
	Are you sure you want to permanently delete this  Directed Pickup Feature Code ({$Extension.Extension}) ?
</p>
<br />


<form method="post" action="Extensions_FC_DirectedPickup_Delete.php">
<p>
