...
function Extensions_Action_Modify() {
	...
	$session = &$_SESSION['IVR_Action_Modify_send_to_voicemail'];
	...
	return $smarty->fetch('IVR_Actions_Modify.send_to_voicemail.tpl');
}
...
function formdata_save($data) {
	if ($data['PK_Action'] == "") {
		...
		$query = "INSERT INTO IVR_Actions (FK_Menu, `Order`, Type) VALUES({$data['FK_Menu']}, {$data['Order']}, 'send_to_voicemail')";
