...
function formdata_save($data) {
	if ($data['PK_Extension'] == "") {
		$query = "INSERT INTO Extensions(Type, Extension) VALUES('ConfCenter', '".mysql_real_escape_string($data['Extension'])."')";
	...
	$query = "
		...
		SET
			...
			TransferExt = '".mysql_real_escape_string($data['TransferExt'])."',
			Invalid = '".mysql_real_escape_string($data['Invalid'])."'
		WHERE
